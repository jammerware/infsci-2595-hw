---
title: "INFSCI 2595 Final, Part 1a: Exploration (Distribution & Counts)"
author: "Ben Stein"
date: "3/23/2022"
...
Because there are many (`r df %>% select(where(is.numeric))`, to be exact) continuous predictors, let's examine their distributions in qualitative groups (i.e. grouped by the methods by which they are derived). Let's put together a quick function so we can easily visualizes different groups of predictors:
