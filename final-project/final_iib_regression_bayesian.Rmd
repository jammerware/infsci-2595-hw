...
If "Residual standard error" here is the MLE on sigma (**.3029**), then it's very close to the median of the posterior distribution on sigma from the Bayesian model (**0.3121201**).