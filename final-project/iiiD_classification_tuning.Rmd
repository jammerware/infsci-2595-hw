...
subtitle: "Part iiiD: Tuning and advanced classification models"
author: "Ben Stein"
date: "4/27/2022"
...
save_model("model5_pairwise_continues_linear_enet", class_model5, prefix = "adv_class_")
```
...
save_model("model10_svm", class_model10, prefix = "adv_class_")
```
