...
What I take from this is that this group is not as useful for predicting `outcome` as some of the other sentiment-based predictor groups, as there is not a clear trend bteween values of each predictor and the outcome.