...
Like the NRC lexicon, it's unclear how this group relates to the outcome. In some cases (e.g. inputs 1, 6, 8), low values of the predictor seem to increase the probability of a nonevent somewhat, but no relationship seems strong.
