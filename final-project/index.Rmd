...
- Part II: Regression
  - Simple regression (lm) models
    - [Model fitting](iiA_regression_simple.html)
    - [Discussion/evaluation](./iiA_regression_discussion.html)
  - [Bayesian regression models](./iiB_regression_bayesian.html)
  - [Prediction-based evaluation](./iiC_regression_predictions.html)
  - [Tuning regression models](./iiD_regression_tuning.html)
- Part III: Classification
  - Simple classification (glm) models
    - [Model fitting](./iiiA_classification_simple.html)
    - [Discussion/evaluation](./iiiA_classification_discussion.html)
  - [Bayesian classification models](./iiiB_classification_bayesian.html)
  - [Prediction-based evaluation](./iiiC_classification_predictions.html)
...
- Part IV: Interpretation and conclusions
  - [Introduction](./ivA_interpretation_intro.html)
  - [Identifying Hardest-to-predict customers](./ivB_hard_to_predict_identify.html)
  - [Visualizing hardest-to-predict customers](./ivC_hard_to_predict_visualize.html)