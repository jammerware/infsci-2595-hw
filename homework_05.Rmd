...
**TODO:** Figure out how to substitute v in

$$

$$

No, the substitution of $v$ eliminates the dependence of the un-normalized log-posterior on $x_n$. Thus, the information in $v$ encodes the relevant info from $x_n$.
...
tibble::tibble(
  ...
  ggplot(mappings = aes(x = sigma, y = log_post))
```
...
**TODO:** get the function figured out
...
tibble::tibble(
  ...
  mutate(log_post = log_post_varphi_unnorm()) %>%
  ggplot(mapping = aes(x = varphi, y = log_post)) + 
  geom_line() + 
