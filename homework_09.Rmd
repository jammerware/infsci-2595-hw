...
summarize_logistic_pred_from_laplace <- function(mvn_result, Xtest, num_samples)
{
  ...
  pred_test <- Xtest %*% t(betas)
  
  # calculate summary statistics on the posterior predicted probability
  # summarize over the posterior samples
  summary_stats <- post_logistic_pred_samples(Xtest, betas)
  
  # posterior mean, should you summarize along rows (rowMeans) or 
  # summarize down columns (colMeans) ???
  mu_avg <- colMeans(summary_stats)
...
# post_pred_summary_cubic <- summarize_logistic_pred_from_laplace(laplace_linear, Xmat_cubic, 2500)
# post_pred_summary_spline7 <- summarize_logistic_pred_from_laplace(laplace_linear, Xmat_spline7, 2500)
```
