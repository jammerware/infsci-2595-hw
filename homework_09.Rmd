...
logistic_logpost <- function(unknowns, my_info)
{
  ...
  # eta <- X * unknowns
  eta <- intercept + coefs * my_info$xobs
...
# laplace_spline7 <- my_laplace(rep(0, 8), logpost_func = logistic_logpost, my_info = info_cubic)
```
...
The modes are the same. Is this because it's a unimodal surface?
