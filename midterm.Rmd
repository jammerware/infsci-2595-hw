...
When the sample size is small, the informative prior influences the the posterior distribution quite heavily. When the sample size is large, the informative prior is less influential on the posterior distribution, and the observed data is more influential.
